...
class Module extends EventEmitter {
    constructor(config) {
        ...
        if(this.config.ctorInit !== false)
            dpc(() => { 
                console.log("Running module...".magenta.bold);
                this.initModule_(); 
            });
    ...
    initModule_() {
        console.log("µFabric::init()".green.bold);
...
//            	this.init();
    ...
    initSTAN() {
        ...
        console.log("initSTAN - ",this.config.cluster || this.config.stan.cluster || 'test-cluster', this.config.ident || this.config.stan.ident || (this.ident+'-'+NUID.next().toLowerCase()), this.config.stan);
